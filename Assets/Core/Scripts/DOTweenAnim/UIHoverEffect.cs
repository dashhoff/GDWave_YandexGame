...
public class UIHoverEffect : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    {
        transform.DOScale(_endScale, _durationToEndScale).SetEase(Ease.InOutBack).SetUpdate(true);
    }

    public void OnPointerExit(PointerEventData eventData)
    {
        transform.DOScale(_startScale, _durationToStartScale).SetEase(Ease.InOutBack).SetUpdate(true);
    }
}
