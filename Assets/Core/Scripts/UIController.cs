...
public class UIController : MonoBehaviour
{
    ...
    public void UpdateMoneyText()
    {
        ...
        if (YandexGame.savesData.language == "ru")
            _moneyText.text = "МОНЕТЫ: " + GameSettings.Instance.Money;
        else
    ...
    public void UpdateBestScoreText()
    {
        ...
        if (YandexGame.savesData.language == "ru")
            _bestScoreText.text = "ЛУЧШИЙ РЕЗУЛЬТАТ: " + GameSettings.Instance.BestScore;
        else
    ...
    public void UpdateScoreText()
    {
        ...
        if (YandexGame.savesData.language == "ru")
            _scoreText.text = "ОЧКИ: " + GameManager.Instance.Score;
        else
